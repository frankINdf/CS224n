...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(shape=(Config.batch_size, Config.n_features), dtype=tf.float32)
        self.labels_placeholder = tf.placeholder(shape=(Config.batch_size, Config.n_classes), dtype=tf.int32)
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        weight = tf.Variable(tf.zeros(shape=(Config.n_features, Config.n_classes)), name="W")
        biase = tf.Variable(tf.zeros(shape=(Config.n_classes)), name="b")
        pred = softmax(tf.matmul(self.input_placeholder, weight) + biase)
        ### END YOUR CODE
        return pred
